...
; Derived from C:\Users\Meinersbur\src\llvm\tools\polly\test\jacobi-1d.c
; Original command: /root/build/llvm/release/bin/clang -DNDEBUG -mllvm -polly -mllvm -polly-process-unprofitable -mllvm -polly-optree-normalize-phi -mllvm -polly-optree-max-ops=0 -mllvm -debug-only=polly-optree,polly-ast -O3 -DNDEBUG -w -Werror=date-time -save-stats=obj -save-stats=obj -I /root/src/llvm/projects/test-suite/Performance/Polybench-421/utilities -DLARGE_DATASET -ffast-math -save-stats=obj -MD -MT Performance/Polybench-421/stencils/jacobi-1d/CMakeFiles/Pb421-perf_jacobi-1d.dir/jacobi-1d.c.o -MF Performance/Polybench-421/stencils/jacobi-1d/CMakeFiles/Pb421-perf_jacobi-1d.dir/jacobi-1d.c.o.d -o Performance/Polybench-421/stencils/jacobi-1d/CMakeFiles/Pb421-perf_jacobi-1d.dir/jacobi-1d.c.o -c /root/src/llvm/projects/test-suite/Performance/Polybench-421/stencils/jacobi-1d/jacobi-1d.c

; ModuleID = 'C:\Users\Meinersbur\src\llvm\tools\polly\test\jacobi-1d.c'
source_filename = "C:\5CUsers\5CMeinersbur\5Csrc\5Cllvm\5Ctools\5Cpolly\5Ctest\5Cjacobi-1d.c"
...
for.body.i:                                       ; preds = %for.body.i, %polybench_alloc_data.exit80
  ...
  store double %div5.i, double* %arrayidx7.i, align 8, !tbaa !2
...
if.then44:                                        ; preds = %if.end39
  ...
  %12 = call i64 @fwrite(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i64 0, i64 0), i64 22, i64 1, %struct._IO_FILE* %11) #8
  %13 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !6
  %call1.i = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %13, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i64 0, i64 0)) #8
...
if.then.i:                                        ; preds = %for.body.i82
  ...
  %fputc.i = call i32 @fputc(i32 10, %struct._IO_FILE* %15) #8
  br label %if.end.i
...
if.end.i:                                         ; preds = %if.then.i, %for.body.i82
  ...
  %17 = load double, double* %arrayidx.i83, align 8, !tbaa !2
  %call4.i = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %16, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.7, i64 0, i64 0), double %17) #8
...
print_array.exit:                                 ; preds = %if.end.i
  ...
  %call5.i = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %18, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i64 0, i64 0)) #8
  %19 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !6
  %20 = call i64 @fwrite(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.9, i64 0, i64 0), i64 22, i64 1, %struct._IO_FILE* %19) #8
  br label %if.end46
...
define internal fastcc void @kernel_jacobi_1d(double* nocapture %A, double* nocapture %B) unnamed_addr #5 {
entry:
  br label %entry.split
...
for.body3:                                        ; preds = %for.body3, %for.body
  ...
  %2 = load double, double* %arrayidx6, align 8, !tbaa !2
...
for.body16:                                       ; preds = %for.body16, %for.end
  ...
  %arrayidx19 = getelementptr inbounds double, double* %B, i64 %4
  %5 = load double, double* %arrayidx19, align 8, !tbaa !2
  %arrayidx21 = getelementptr inbounds double, double* %B, i64 %indvars.iv5
  %6 = load double, double* %arrayidx21, align 8, !tbaa !2
  %add22 = fadd fast double %6, %5
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %arrayidx25 = getelementptr inbounds double, double* %B, i64 %indvars.iv.next6
  %7 = load double, double* %arrayidx25, align 8, !tbaa !2
  %add26 = fadd fast double %add22, %7
